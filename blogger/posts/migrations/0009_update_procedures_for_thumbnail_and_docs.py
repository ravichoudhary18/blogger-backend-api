...
class Migration(migrations.Migration):
    dependencies = [
        ("posts", "0008_post_interaction_counts"),
    ]

    operations = [
        # Update add_post procedure
        migrations.RunSQL(
            sql="""
            ...
            $$;
            """,
            reverse_sql="DROP PROCEDURE IF EXISTS add_post(VARCHAR, TEXT, INT, VARCHAR, TIMESTAMP WITH TIME ZONE, TIMESTAMP WITH TIME ZONE, VARCHAR);",
        ),
        # Update update_post procedure
        migrations.RunSQL(
            sql="""
            ...
            $$;
            """,
            reverse_sql="DROP PROCEDURE IF EXISTS update_post(INT, VARCHAR, TEXT, VARCHAR, INT, TIMESTAMP WITH TIME ZONE, VARCHAR);",
        ),
        # Update get_post_by_id function to include thumbnail and documents
        migrations.RunSQL(
            sql="""
        ...
        # Update get_posts function to include thumbnail
        migrations.RunSQL(
            sql="""
